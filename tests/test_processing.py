...
def test_filter_by_state(list_date: list):
...
def test_sort_by_date(list_date: list):
        assert sort_by_date(list_date) == [{'id': 41428829, 'state': 'EXECUTED',
        ...
        # assert sort_by_date(list_date) == [{'id': 939719570, 'state': 'EXECUTED',
        #                                     'date': '2018-06-30T02:08:58.425572'},
        #                                    {'id': 594226727, 'state': 'CANCELED',
        #                                     'date': '2018-09-12T21:27:25.241689'},
        #                                    {'id': 615064591, "state": "CANCELED",
